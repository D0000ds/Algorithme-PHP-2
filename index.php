...
$capitales2 = array(
    "France"=> "Paris","https://fr.wikipedia.org/wiki/Paris",
    "Allemagne"=> "Berlin","https://fr.wikipedia.org/wiki/Berlin",
    "USA"=> "Washington", "https://fr.wikipedia.org/wiki/Washington_(district_de_Columbia)",
    "Italie"=>"Rome", "https://fr.wikipedia.org/wiki/Rome",
    "Espagne"=>"Madrid", "https://fr.wikipedia.org/wiki/Madrid"
);
...
function afficherTableHTML2($capitales2){
    ...
    foreach($capitales2 as $pays2 => $villes2){
        echo "<tr><td>". strtoupper($pays2)."</td><td>". $villes2."</td></tr>";    
    }
    echo "</table>";
}
